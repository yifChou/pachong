    ...
    def get_httpsid(self):
        for i in range(1, 10):
            ...
            for ip in IP:
                ip = ip[0] + ":" + ip[1]
                print(ip)
                self.https_ip_list.append(ip)
        with open("httpsip.txt","wb") as f:
            f.writelines(self.https_ip_list)
        print(self.http_ip_list)
        return self.http_ip_list
    ...
    def get_httpip(self):
        for i in range(1, 10):
            ...
            for ip in IP:
                ip = ip[0] + ":" + ip[1]
                # print(ip)
                self.http_ip_list.append(ip)
        with open("httpip.txt","wb") as f:
            f.writelines(self.http_ip_list)
        return self.http_ip_list
